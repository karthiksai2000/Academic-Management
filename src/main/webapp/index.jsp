                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-grid gap-3 col-md-6 mx-auto">
                            <!-- FIXED: Added Submit New Assignment button with Struts action -->
                            <s:url action="assignment-form" var="formUrl"/>
                            <a href="${formUrl}" class="btn btn-primary btn-lg">
                                Submit New Assignment
                            </a>
                            
                            <!-- FIXED: View Submitted Assignments now uses Struts action -->
                            <s:url action="view-assignments" var="viewUrl"/>
                            <a href="${viewUrl}" class="btn btn-outline-secondary btn-lg">
